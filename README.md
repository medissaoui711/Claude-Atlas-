...
[استكشف الخريطة المعمارية](#-أقسام-المنصة--platform-sections) • [المسارات التعليمية](#-المسارات-التعليمية--learning-paths) • [منظومة التوثيق المعماري](./docs/README.md) • [التشغيل المحلي](#-التثبيت-والتشغيل-المحلي--getting-started)

</div>

---

## 📚 منظومة التوثيق المعماري والهندسي | Architecture Documentation

يحتوي المشروع على **منظومة توثيق شاملة ومتكاملة** داخل مجلد [`docs/`](./docs/README.md) تغطي المنظومة من المستوى المعماري حتى تفاصيل الشيفرة وسير العمل:

- 🧭 **[مركز التوثيق الرئيسي والخريطة](./docs/README.md)**: الدليل العام وفهرس التوثيق الشامل.
- 📐 **[المعمارية ومخططات النظام](./docs/02-architecture/architecture-overview.md)**: تفكيك الطبقات، ومخططات Mermaid المعمارية.
- 💻 **[دليل الشيفرة والمكونات](./docs/03-codebase/codebase-overview.md)**: خريطة الواجهات الـ 10، المكونات، وإدارة الحالة.
- 🛠️ **[دليل التطوير وإعداد البيئة](./docs/04-development/setup.md)**: خطوات الإعداد، الأوامر الفعلية، ومعايير الكود.
- 📋 **[سجل القرارات المعمارية (ADR)](./docs/adr/README.md)**: القرارات التاريخية المعتمدة وأسبابها.
